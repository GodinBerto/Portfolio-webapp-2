...
import { DocsData } from "@/app/docs/data";
...
export default function Sidebar() {
  ...
  return (
    <div className="dark:text-white border-r-[1px] border-gray-700 h-full w-[300px] fixed py-6 px-4 overflow-y-auto dark:bg-semiblack">
